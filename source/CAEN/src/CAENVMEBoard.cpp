...
void Pulser::setTimeUnits(const std::string &time) { m_TimeUnits = time; }

void Pulser::setPeriod(const unsigned int &period) { m_Period = period; }

void Pulser::setWidth(const unsigned int &width) { m_Width = width; }

void Pulser::setPulseNbr(const unsigned int &pulsenbr) {
  m_PulseNbr = pulsenbr;
}

std::string Pulser::getIOSourcesStart() { return m_IOSourcesStart; }

std::string Pulser::getIOSourcesStop() { return m_IOSourcesStop; }

std::string Pulser::getTimeUnits() { return m_TimeUnits; }
...
unsigned char Pulser::returnTimeUnits() { return returnTimeUnits(m_TimeUnits); }

unsigned char Pulser::getPeriod() { return m_Period; }

unsigned char Pulser::getWidth() { return m_Width; }

unsigned char Pulser::getPulseNbr() { return m_PulseNbr; }

CAENVMEBoard::CAENVMEBoard(const std::string &name)
    : Board(name, "CAENVMEBoard") {}
