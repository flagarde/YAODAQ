...
std::string Module::getName() { return m_Name; }
std::string Module::getType() { return m_Type; }
...
void Module::printParameters() { std::cout << m_Conf << std::endl; }
...
void Module::DoInitialize() { std::cout << "Initialize" << std::endl; }

void Module::DoConnect() { std::cout << "Connect" << std::endl; }

void Module::DoConfigure() { std::cout << "Configure" << std::endl; }

void Module::DoStart() { std::cout << "Start" << std::endl; }

void Module::DoPause() { std::cout << "Pause" << std::endl; }

void Module::DoStop() { std::cout << "Stop" << std::endl; }

void Module::DoClear() { std::cout << "Clear" << std::endl; }

void Module::DoDisconnect() { std::cout << "Disconnect" << std::endl; }

void Module::DoRelease() { std::cout << "Release" << std::endl; }

void Module::DoQuit() { std::cout << "Quit" << std::endl; }
