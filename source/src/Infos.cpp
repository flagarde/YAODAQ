...
void Infos::setRoomIndex(const int &index) { m_RoomIndex = index; }

void Infos::setRackIndex(const int &index) { m_RackIndex = index; }

void Infos::setCrateIndex(const int &index) { m_CrateIndex = index; }

void Infos::setIndex(const int &index) { m_Index = index; }

std::string Infos::getRoomName() const { return m_RoomName; }

std::string Infos::getRackName() const { return m_RackName; }

std::string Infos::getCrateName() const { return m_CrateName; }

std::string Infos::getName() const { return m_Name; }

std::string Infos::getType() const { return m_Type; }

int Infos::getRoomIndex() const { return m_RoomIndex; }

int Infos::getRackIndex() const { return m_RackIndex; }

int Infos::getCrateIndex() const { return m_CrateIndex; }

int Infos::getIndex() const { return m_Index; }
