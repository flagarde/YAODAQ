...
public:
  ...
  Exception(const StatusCode& statusCode, const std::string& format, const std::tuple<Ta...>& t, const SourceLocation& location = SourceLocation())
      : m_Code(static_cast<std::int_least32_t>(statusCode)), m_Description(fmt::format(format, t)), m_SourceLocation(location)
  {
    constructMessage();
  }
  //1
  ...
  Exception(const StatusCode& statusCode, const std::string& format, T0&& t0, const SourceLocation& location = SourceLocation())
      : m_Code(static_cast<std::int_least32_t>(statusCode)), m_Description(fmt::format(format, t0)), m_SourceLocation(location)
  {
    constructMessage();
  }
  //2
  ...
  Exception(const StatusCode& statusCode, const std::string& format, T0&& t0, T1&& t1, const SourceLocation& location = SourceLocation())
      : m_Code(static_cast<std::int_least32_t>(statusCode)), m_Description(fmt::format(format, t0, t1)), m_SourceLocation(location)
  {
    constructMessage();
  }
  //3
  ...
  Exception(const StatusCode& statusCode, const std::string& format, T0&& t0, T1&& t1, T2&& t2, const SourceLocation& location = SourceLocation())
      : m_Code(static_cast<std::int_least32_t>(statusCode)), m_Description(fmt::format(format, t0, t1, t2)), m_SourceLocation(location)
  {
    constructMessage();
  }
  //4
  ...
  Exception(const StatusCode& statusCode, const std::string& format, T0&& t0, T1&& t1, T2&& t2, T3&& t3, const SourceLocation& location = SourceLocation())
      : m_Code(static_cast<std::int_least32_t>(statusCode)), m_Description(fmt::format(format, t0, t1, t2, t3)), m_SourceLocation(location)
  {
    constructMessage();
  }
  //5
  ...
  Exception(const StatusCode& statusCode, const std::string& format, T0&& t0, T1&& t1, T2&& t2, T3&& t3, T4&& t4, const SourceLocation& location = SourceLocation())
      : m_Code(static_cast<std::int_least32_t>(statusCode)), m_Description(fmt::format(format, t0, t1, t2, t3, t4)), m_SourceLocation(location)
  {
    constructMessage();
  }
  //6
  ...
  Exception(const StatusCode& statusCode, const std::string& format, T0&& t0, T1&& t1, T2&& t2, T3&& t3, T4&& t4, T5&& t5, const SourceLocation& location = SourceLocation())
      : m_Code(static_cast<std::int_least32_t>(statusCode)), m_Description(fmt::format(format, t0, t1, t2, t3, t4, t5)), m_SourceLocation(location)
  {
    constructMessage();
  }
  //7
  ...
  Exception(const StatusCode& statusCode, const std::string& format, T0&& t0, T1&& t1, T2&& t2, T3&& t3, T4&& t4, T5&& t5, T6&& t6, const SourceLocation& location = SourceLocation())
      : m_Code(static_cast<std::int_least32_t>(statusCode)), m_Description(fmt::format(format, t0, t1, t2, t3, t4, t5, t6)), m_SourceLocation(location)
  {
    constructMessage();
  }
  //8
  ...
  Exception(const StatusCode& statusCode, const std::string& format, T0&& t0, T1&& t1, T2&& t2, T3&& t3, T4&& t4, T5&& t5, T6&& t6, T7&& t7, const SourceLocation& location = SourceLocation())
      : m_Code(static_cast<std::int_least32_t>(statusCode)), m_Description(fmt::format(format, t0, t1, t2, t3, t4, t5, t6, t7)), m_SourceLocation(location)
  {
    constructMessage();
  }
  //9
  ...
  Exception(const StatusCode& statusCode, const std::string& format, T0&& t0, T1&& t1, T2&& t2, T3&& t3, T4&& t4, T5&& t5, T6&& t6, T7&& t7, T8&& t8, const SourceLocation& location = SourceLocation())
      : m_Code(static_cast<std::int_least32_t>(statusCode)), m_Description(fmt::format(format, t0, t1, t2, t3, t4, t5, t6, t7, t8)), m_SourceLocation(location)
  {
    constructMessage();
  }
