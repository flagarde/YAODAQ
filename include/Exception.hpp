...
class Exception: public std::exception, public SourceLocation
{
public:
  Exception() = delete;
  ...
  : SourceLocation(location), m_Code(static_cast<int_least32_t>(statusCode)), m_Description(fmt::format(format, t))
  {
    constructMessage();
  }
  //1
  ...
  : SourceLocation(location), m_Code(static_cast<int_least32_t>(statusCode)), m_Description(fmt::format(format, t0))
  {
    constructMessage();
  }
  //2
  ...
  : SourceLocation(location), m_Code(static_cast<int_least32_t>(statusCode)), m_Description(fmt::format(format, t0, t1))
  {
    constructMessage();
  }
  //3
  ...
  : SourceLocation(location), m_Code(static_cast<int_least32_t>(statusCode)), m_Description(fmt::format(format, t0, t1, t2))
  {
    constructMessage();
  }
  //4
  ...
  : SourceLocation(location), m_Code(static_cast<int_least32_t>(statusCode)), m_Description(fmt::format(format, t0, t1, t2, t3))
  {
    constructMessage();
  }
  //5
  ...
  : SourceLocation(location), m_Code(static_cast<int_least32_t>(statusCode)), m_Description(fmt::format(format, t0, t1, t2, t3, t4))
  {
    constructMessage();
  }
  //6
  ...
  : SourceLocation(location), m_Code(static_cast<int_least32_t>(statusCode)), m_Description(fmt::format(format, t0, t1, t2, t3, t4, t5))
  {
    constructMessage();
  }
  //7
  ...
  : SourceLocation(location), m_Code(static_cast<int_least32_t>(statusCode)), m_Description(fmt::format(format, t0, t1, t2, t3, t4, t5, t6))
  {
    constructMessage();
  }
  //8
  ...
  : SourceLocation(location), m_Code(static_cast<int_least32_t>(statusCode)), m_Description(fmt::format(format, t0, t1, t2, t3, t4, t5, t6, t7))
  {
    constructMessage();
  }
  //9
  ...
  : SourceLocation(location), m_Code(static_cast<int_least32_t>(statusCode)), m_Description(fmt::format(format, t0, t1, t2, t3, t4, t5, t6, t7, t8))
  {
    constructMessage();
  }
