...
ExternalProject_Add(
                    ...
                    GIT_PROGRESS TRUE
                    GIT_SHALLOW TRUE
                    CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX} -DCMAKE_CXX_STANDARD=${CMAKE_CXX_STANDARD} -DCMAKE_CXX_STANDARD_REQUIRED=${CMAKE_CXX_STANDARD_REQUIRED} -DCMAKE_CXX_EXTENSIONS=${CMAKE_CXX_EXTENSIONS} -DSOCI_SHARED=OFF -DSOCI_STATIC=ON -DSOCI_TESTS=OFF -DSOCI_HAVE_BOOST=FALSE -DSOCI_HAVE_BOOST_DATE_TIME=FALSE -DLIB_SUFFIX="" -DWITH_BOOST=OFF -DSOCI_LIBDIR=lib
                    GIT_SUBMODULES "" 
