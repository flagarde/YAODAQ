...
if(UNIX)
  set(DB2_INSTALL_PATHS /opt/ibm/db2/V10.1 /opt/ibm/db2/V9.7 /opt/ibm/db2/V9.5
                        /opt/ibm/db2/V9.1 /opt/ibm/clidriver /opt/clidriver)
...
elseif(WIN32)
  if(CMAKE_CL_64) # 64-bit build, DB2 64-bit installed
    ...
    if(EXISTS "$ENV{ProgramW6432}/IBM/SQLLIB/lib")
      # On 64-bit Windows with DB2 64-bit installed: LIB environment points to
      # {DB2}/IBM/SQLLIB/lib with64-bit db2api.lib, this flag prevents checking
      # paths in LIB, so Win32 version can be detected
...
find_library(
  DB2_LIBRARY
  NAMES db2 db2api
  PATHS $ENV{DB2LIB} $ENV{IBM_DB_LIB} ${DB2_FIND_LIB_PATHS}
        ${DB2_FIND_LIB_NO_LIB})
...
# Handle the QUIETLY and REQUIRED arguments and set DB2_FOUND to TRUE if all
