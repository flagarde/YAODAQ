...
function(cmmm)
  ...
  if(NOT CMMM_NO_COLOR)
    set(CMMM_DEFAULT_COLORS "default=0;33:fatal_error=1;31:error=0;31:warn=0;33:info=0;32")
  ...
  message(LSLSLS ${CMMM_ESC}${CMMM_DEFAULT_COLOR}gggggg)
  ...
  if(NOT "${CMMM_FETCHED_VERSION}" STREQUAL "${CMMM_VERSION}")
    while(NOT CMAKEMM_INITIALIZED_${CMMM_TAG} OR NOT EXISTS "${CMMM_DESTINATION}/CMakeMM-${CMMM_TAG}.cmake" OR "${CMakeMMSHA256}" STREQUAL "${CMMM_EMPTY_FILE_SHA256}")
      ...
      if(${CMMM_RETRIES_DONE} STREQUAL "0")
        message(STATUS "${CMMM_ESC}${CMMM_DEFAULT_COLOR}ggggg${CMMM_ESC}${CMMM_DEFAULT_COLOR}[cmmm] Downloading CMakeMM.cmake@${CMMM_VERSION} (${CMMM_TAG}) to ${CMMM_DESTINATION}/CMakeMM-${CMMM_TAG}.cmake${CMMM_ESC}${CMMM_RESET_COLOR}")
      else()
