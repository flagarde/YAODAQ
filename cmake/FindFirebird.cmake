...
# This module defines FIREBIRD_INCLUDE_DIR - where to find ibase.h
# FIREBIRD_LIBRARIES - the libraries to link against to use FIREBIRD
# FIREBIRD_FOUND - true if FIREBIRD was found

find_path(FIREBIRD_INCLUDE_DIR ibase.h /usr/include
...
find_library(
  ...
  PATHS /usr/lib $ENV{ProgramFiles}/Firebird/*/lib)

# fbembed ?

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(Firebird DEFAULT_MSG FIREBIRD_LIBRARIES
