...
function(SETUP_TARGET_FOR_COVERAGE _targetname _testrunner _outputname)
  ...
  add_custom_target(
    ...
    COMMAND
      ...
      '*/external/*' '/Applications/*' --output-file ${_outputname}.info.cleaned
...
if(cmake_build_type_tolower STREQUAL "coverage")
  ...
  add_custom_target(
    ...
    COMMAND
      echo
      "Make a new build directory and rerun cmake with -DCMAKE_BUILD_TYPE=Coverage to enable this target."
  )
endif()
