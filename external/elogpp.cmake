if(NOT TARGET elogpp)
  ...
  ExternalProject_Add(elogpp_project
                      ...
                      GIT_PROGRESS TRUE
                      GIT_SHALLOW TRUE
                      CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX} -DCMAKE_CXX_STANDARD=${CMAKE_CXX_STANDARD} -DCMAKE_CXX_STANDARD_REQUIRED=${CMAKE_CXX_STANDARD_REQUIRED} -DCMAKE_CXX_EXTENSIONS=${CMAKE_CXX_EXTENSIONS} -DCMAKE_POSITION_INDEPENDENT_CODE=${CMAKE_POSITION_INDEPENDENT_CODE} -DOPENSSL_ROOT_DIR=${CMAKE_INSTALL_PREFIX} -DUSE_SYSTEM_JSONCPP=TRUE -Djsoncpp_DIR="${CMAKE_INSTALL_PREFIX}/lib/cmake/jsoncpp/"
