...
if(NOT LCIO_FOUND)
  ...
  ExternalProject_Add(LCIO_project
                      ...
                      CMAKE_ARGS -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX} -DCMAKE_CXX_STANDARD=${CMAKE_CXX_STANDARD} -DCMAKE_CXX_STANDARD_REQUIRED=${CMAKE_CXX_STANDARD_REQUIRED} -DCMAKE_CXX_EXTENSIONS=${CMAKE_CXX_EXTENSIONS} -DCMAKE_POSITION_INDEPENDENT_CODE=${CMAKE_POSITION_INDEPENDENT_CODE} -DINSTALL_JAR=OFF -DLCIO_GENERATE_HEADERS=OFF -DBUILD_ROOTDICT=OFF -DBUILD_LCIO_EXAMPLES=OFF -DBUILD_F77_TESTJOBS=OFF -DINSTALL_DOC=OFF -DBUILD_TESTING=OFF -DBUILD_FORTRAN=OFF -DINSTALL_PYTHON=OFF
                      PREFIX ${CMAKE_BINARY_DIR}/LCIO_project
                      INSTALL_DIR ${CMAKE_INSTALL_PREFIX}
                    )
  add_library(LCIO_internal INTERFACE)
  add_dependencies(LCIO_internal LCIO_project)
  target_include_directories(LCIO_internal INTERFACE "${CMAKE_INSTALL_PREFIX}/include" INTERFACE "${CMAKE_INSTALL_PREFIX}/include/DATA" INTERFACE "${CMAKE_INSTALL_PREFIX}/include/EVENT" INTERFACE "${CMAKE_INSTALL_PREFIX}/include/IMPL" INTERFACE "${CMAKE_INSTALL_PREFIX}/include/IO" INTERFACE "${CMAKE_INSTALL_PREFIX}/include/IOIMPL" INTERFACE "${CMAKE_INSTALL_PREFIX}/include/LCIO" INTERFACE "${CMAKE_INSTALL_PREFIX}/include/MT" INTERFACE "${CMAKE_INSTALL_PREFIX}/include/rootDict" INTERFACE "${CMAKE_INSTALL_PREFIX}/include/SIO" INTERFACE "${CMAKE_INSTALL_PREFIX}/include/UTIL")
