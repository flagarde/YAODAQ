...
public:
  ...
  ******************************************************************************/
  ...
  /**
  * \fn        void Reset();
  * \brief     Resets the Digitizer. All internal registers and states are restored to defaults.
  ******************************************************************************/
  void Reset();
  ...
  * \return    shows current DES mode status (enabled/disabled)
  ******************************************************************************/
  ...
  *                           DPP-PSD and DPP-CI require this parameter,
  *                           DPP-PHA ignores it
  * \return  the size of the record (in samples)
  ******************************************************************************/
  ...
  */
  ...
  CAEN_DGTZ_ErrorCode CAENDGTZ_API CAEN_DGTZ_SendSAMPulse(int handle); CAEN_DGTZ_ErrorCode CAENDGTZ_API
  ...
  ******************************************************************************/
  ...
  /*! \fn      int WriteRegisterBitmask(uint32_t address,uint32_t data, uint32_t mask) 
  * \brief   writes 'data' on register at 'address' using 'mask' as bitmask 
  * \param   address:   Address of the Register to write \param   data   :   Data to Write on the Register 
  ...
  */
  ...
  /*! \brief   return true if board descriped by 'BoardInfo' supports calibration or not.
   */
