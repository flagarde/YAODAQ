...
namespace CAEN
{
const char* CAENDigitizerException::errorStrings(const int_least32_t& code)
{
  switch(code)
  {
...
CAENDigitizerException::CAENDigitizerException(const int_least32_t& code, const source_location& location): Exception(code, errorStrings(code), location)
{
